...
with custom_object_scope({'CTCLayer': CTCLayer}):
    img_path = "C:\\Users\\rites\\OneDrive\\Desktop\\dp_inference_H.jpeg"
    ...
    print(img2.shape)
    # gathering text
    prediction_model = tf.keras.models.load_model("dp_project_models\\my_model_epoch_15.h5")
    print("----------------------------------Predicting Now -----------------------------------")
    preds2 = prediction_model.predict(img_list)
    # preds2 = prediction_model.predict([np.expand_dims(img2, axis=0), np.expand_dims(test_labels, axis=0)])
